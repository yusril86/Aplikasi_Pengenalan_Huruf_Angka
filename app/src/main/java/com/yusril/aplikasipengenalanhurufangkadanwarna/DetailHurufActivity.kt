...
class DetailHurufActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listF = listOf(R.drawable.image_f1, R.drawable.image_f2, R.drawable.image_f3)
        val listG = listOf(R.drawable.image_g1, R.drawable.image_g2, R.drawable.image_g3)
        val listH = listOf(R.drawable.image_h1, R.drawable.image_h2, R.drawable.image_h3)
        val listI = listOf(R.drawable.image_i1, R.drawable.image_i2, R.drawable.image_h3)
        val listJ = listOf(R.drawable.image_j1, R.drawable.image_j2, R.drawable.image_j3)
        val listK = listOf(R.drawable.image_k1, R.drawable.image_k2, R.drawable.image_k3)
        val listL = listOf(R.drawable.image_l1, R.drawable.image_l2, R.drawable.image_l3)
        val listM = listOf(R.drawable.image_m1, R.drawable.image_m2, R.drawable.image_m3)
        val listN = listOf(R.drawable.image_n1, R.drawable.image_n2, R.drawable.image_n3)
        val listO = listOf(R.drawable.image_o1, R.drawable.image_o2, R.drawable.image_o3)
        val listP = listOf(R.drawable.image_p1, R.drawable.image_p2, R.drawable.image_p3)
        val listQ = listOf(R.drawable.image_q1, R.drawable.image_q2, R.drawable.image_q3)
        val listR = listOf(R.drawable.image_r1, R.drawable.image_r2, R.drawable.image_r3)
        val listS = listOf(R.drawable.image_s1, R.drawable.image_s2, R.drawable.image_s3)
        val listT = listOf(R.drawable.image_t1, R.drawable.image_t2, R.drawable.image_t3)
        val listU = listOf(R.drawable.image_u1, R.drawable.image_u2, R.drawable.image_u3)
        val listV = listOf(R.drawable.image_v1, R.drawable.image_v2, R.drawable.image_v3)
        val listW = listOf(R.drawable.image_w1, R.drawable.image_w2, R.drawable.image_w3)
        val listX = listOf(R.drawable.image_x1, R.drawable.image_x2, R.drawable.image_x3)
        val listY = listOf(R.drawable.image_y1, R.drawable.image_y2, R.drawable.image_y3)
        val listZ = listOf(R.drawable.image_z1, R.drawable.image_z2, R.drawable.image_z3)
